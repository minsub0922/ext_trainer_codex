...
MODEL_CONFIG="${MODEL_CONFIG:-configs/models/olmo3_poc.yaml}"
SFT_CONFIG="${SFT_CONFIG:-configs/sft/olmo3_poc_sft.yaml}"
RUNTIME_CONFIG="${RUNTIME_CONFIG:-/tmp/olmo3_runtime_sft.yaml}"
